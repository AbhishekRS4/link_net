...
from link_net_utils import read_config_file, init
...
def infer(FLAGS):
    ...
    link_net.resnet34_encoder(image_features_infer)
    link_net.link_net_decoder()
    network_logits = link_net.logits
    ...
    for img_file in list_images_infer:
        ...
        cv2.imwrite(os.path.join(
            os.getcwd(), model_dir, labels_dir, "label_" + img_file.split("/")[-1]),
            labels_predicted
        )
